...
void main() {
  ...
  testWidgets('Test loading image', (tester) async {
    ...
    // Valid PNG image data
    // @formatter:off
    var validImageData = Uint8List.fromList([
      ...
      0x00, 0x3F, 0x00, 0xFD, 0xFC, 0x28, 0xA2, 0x8A, 0x00, 0xFF, 0xD9
    ]);
    // @formatter:on
    ...
    when(() => mockResponse.contentLength).thenReturn(validImageData.length);
    ...
    when(() => mockResponse.listen(any(),
      ...
      onData(validImageData);
      if (onDone != null) {
        onDone();
      }
      return Stream<Uint8List>.fromIterable([validImageData]).listen(null);
    });
    ...
    HttpOverrides.runZoned(() async {
      ...
      // Test that once all the data is fetched, an Image widget is shown
